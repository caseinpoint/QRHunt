		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-12 mx-auto py-3">
					...
					<h1 class="mt-5">Edit Hint</h1>
					<f:form action="/games/${hint.getGame().getId()}/hint/${hint.getId()}" method="post" modelAttribute="hint">
						<f:input type="hidden" path="id"/>
						<f:input type="hidden" path="game"/>
						<div class="form-group">
							<f:label path="text"><strong>Hint:</strong></f:label>
